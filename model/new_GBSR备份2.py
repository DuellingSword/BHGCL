    ...
    def graph_reconstruction(self):
        ...
        for key in self.meta_path_patterns.keys():
            for meta_path_pattern in self.meta_path_patterns[key]:
                ...
                row_emb = self.feature_dict[key][row]
                col_emb = self.feature_dict[key][col]
                ...
                masked_values = self.UI_interaction_values[key][str(meta_path_pattern)] * mask_gate_input
